...
export const links = [
  ...
  <NavLink className='tabs-bar__link' exact to='/timelines/public' data-preview-title-id='column.public' data-preview-icon='globe' ><Icon id='globe' fixedWidth /><FormattedMessage id='tabs_bar.live_stream' defaultMessage='Live Stream' /></NavLink>,
  <NavLink className='tabs-bar__link' exact to='/timelines/trend' data-preview-title-id='column.trend' data-preview-icon='bar-chart' ><Icon id='bar-chart' fixedWidth /><FormattedMessage id='tabs_bar.trends' defaultMessage='Trends' /></NavLink>,
