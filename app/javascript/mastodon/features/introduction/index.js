...
import intro1 from '../../../images/brighteon-social/intro_1.png';
import intro2 from '../../../images/brighteon-social/intro_2.png';
import intro3 from '../../../images/brighteon-social/intro_3.png';

const FrameWelcome = ({ domain, onNext }) => (
  <div className='introduction__frame'>
    <div className='introduction__illustration' style={{ background: `#000a3d url(${intro1}) no-repeat center bottom / auto 90%` }} />
    <div className='introduction__text introduction__text--centered'>
      ...
      <p><FormattedMessage id='introduction.welcome.text' defaultMessage="Welcome to Brighteon.Social! In a few moments, you'll be able to broadcast messages and talk to your friends across our {domain} Network." values={{ domain: <code>{domain}</code> }} /></p>
    </div>
...
const FrameFederation = ({ onNext }) => (
  <div className='introduction__frame'>
    <div className='introduction__illustration' style={{ background: `#000a3d url(${intro2}) no-repeat center center / auto 90%` }} />
    ...
    <div className='introduction__text introduction__text--columnized'>
      <div>
        ...
        <p><FormattedMessage id='introduction.federation.home.text' defaultMessage='Posts from people you follow will appear in your home feed. You can follow anyone on our network.' /></p>
      </div>

      <div>
        <h3><FormattedMessage id='introduction.federation.trending.headline' defaultMessage='Trends' /></h3>
        <p><FormattedMessage id='introduction.federation.trending.text' defaultMessage='The most popular public posts from people who have joined Brighteon.Social' /></p>
      </div>

      <div>
        <h3><FormattedMessage id='introduction.federation.trending_now.headline' defaultMessage='Trending Now' /></h3>
        <p><FormattedMessage id='introduction.federation.trending_now.text' defaultMessage='See all the censored news headlines in real time.' /></p>
      </div>
    </div>
...
const FrameInteractions = ({ onNext }) => (
  <div className='introduction__frame'>
    <div className='introduction__illustration' style={{ background: `#000a3d url(${intro3}) no-repeat center bottom / auto 95%` }} />
    ...
    <div className='introduction__text introduction__text--columnized'>
      ...
      <div>
        ...
        <p><FormattedMessage id='introduction.interactions.favourite.text' defaultMessage='You can save a post for later, and let the author know that you liked it, by saving it as a favorite.' /></p>
      </div>
    </div>
